...
\usepackage{fancyhdr}
\usepackage[a4paper,tmargin=15mm,lmargin=27mm,bmargin=15mm,rmargin=27mm,verbose]{geometry} %% add the 'showframe' attribute to show the page component's frame
\usepackage{float}
\usepackage{tikz}
...
\begin{document}
\thispagestyle{empty} %% Possible options: 'empty' / 'plain' / 'headings' / 'myheadings'
